...
### `#leitor-modo-voz`
- Botão novo do player para alternar entre `Nativa` e `SuperVoz`.
- Reaproveita o estilo do botão de velocidade.
- Quando SuperVoz está ativa, recebe a classe `.leitor-modo-supervoz` e fica verde.
